...
module.exports = {
	...
	'GET /api/token/:address': async (ctx, next) => {
		var token_protocol = '';
		try {
			var contract = CONTRACT_ERC20_BASIC.at(ctx.params.address);
